 ...
 * Worker 2 - Handles 2FA, org invitation, security alerts, device auth emails
 */
 ...
 * Start worker 2
 */
export async function startMailWorker2(): Promise<any> {
...
export default startMailWorker2;
